...
function Mirror() {
  ...
  if (hostname === 'karune.tk') {
    url = "https://karune.ml" + pathname;
    window.alert("即将前往Karuneの分店🌈");
    window.location.href = url;
  }
  else if(hostname === 'karune.ml') {
    url = "https://karune.tk" + pathname;
    window.alert("正在返回Karune本部🌸！");
    window.location.href = url;
  }
  else {
